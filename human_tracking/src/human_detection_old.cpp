...
//		ros::Subscriber depth_image;
		...
		void imageCallback_(const ImageConstPtr& rgb_img, const PointCloud2ConstPtr& depth_img );
...
void HumanDetection::imageCallback_(const ImageConstPtr& rgb_img, const PointCloud2ConstPtr& depth_img){
